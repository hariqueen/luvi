  ...
  return (
    <section className="mt-10 border-t border-line pt-6 text-[12px] leading-relaxed text-muted">
      ...
      <ul className="space-y-1.5">
        {/*
          응답 "약속" 은 하지 않기로 했습니다 (지킬 수 없는 선을 긋지 않기 위해).
          운영시간은 약속이 아니라 사실이고, "밤에 답이 없어도 정상" 을 알려주면
          재문의·독촉이 줄어듭니다.
        */}
        <li>· 문의는 평일 10:00 ~ 19:00 에 확인합니다. 확인한 뒤 순서대로 답변드립니다.</li>
        <li>· 내용을 자세히 남겨주시면 훨씬 빠르게 도와드릴 수 있습니다.</li>
        <li>
          · 답변은 이메일로 보내드리며, 로그인하고 문의하시면 이 사이트에서도 확인하실 수 있습니다.
        </li>
        {/*
        ...
        */}
        <li>
          · 성희롱·욕설 등 폭언이 있는 경우 상담이 제한되거나 법적 조치가 이루어질 수 있습니다.
        </li>
        <li>
          · 문의 접수 시 개인정보를 수집합니다. 자세한 내용은{' '}
